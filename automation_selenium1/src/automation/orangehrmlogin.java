...
public class orangehrmlogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		loginStep(driver,"64775","admin123","Unable to login");
		loginStep(driver,"Admin","56372764","Unable to login");
		loginStep(driver,"8487fhu","hfnjd4657","Unable to login");
		loginStep(driver,"","","Unable to login");
		loginStep(driver,"Admin","admin123","User is able to login succesfully");
